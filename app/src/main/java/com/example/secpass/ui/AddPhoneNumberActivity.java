        ...
        btnSavephonenumber.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               MyDatabaseHelper myDB = new MyDatabaseHelper(AddPhoneNumberActivity.this);
                myDB.addPhoneno(edt_texttitle.getText().toString().trim(),
                        Integer.valueOf(edt_mobileno.getText().toString().trim()),

                      //  edt_mobileno.getText().toString().trim(),
                        "uug","gg",
                        edt_Notes.getText().toString().trim()
                );
